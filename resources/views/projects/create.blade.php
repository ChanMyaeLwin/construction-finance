        ...
        <form method="POST" action="{{ route('projects.store') }}" class="space-y-3">
            ...
            <div class="grid grid-cols-2 gap-3">
                <div>
                    ...
                    <input type="number" step="0.01" min="0" name="accounts_receivable" value="{{ old('accounts_receivable') }}" required class="mt-1 w-full rounded-xl border-gray-300 focus:ring-indigo-500" />
                </div>
                <div>
